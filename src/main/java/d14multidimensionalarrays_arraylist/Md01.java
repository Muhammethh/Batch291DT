...
public class Md01 {
    ...
    public static void main(String[] args) {
        ...
        int[][] a = new int[3][2]; // 3 dışta ki, 2 içteki eleman sayısı
        ...
        System.out.println(Arrays.toString(a)); // [[I@e9e54c2, [I@65ab7765, [I@1b28cdfa]
        ...
        System.out.println(Arrays.toString(students[2])); //[Ayhan, Beyhan, Seyhan]

        System.out.println(students[2][2]); //Seyhan
