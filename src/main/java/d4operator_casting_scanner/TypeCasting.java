...
public class TypeCasting {
    ...
    public static void main(String[] args) {
        ...
        //Ornek 2: int data type’ ini short data type’ ina ceviriniz. (EcplicitNarrowing)
        //Example 2: Convert int data type to short data type.

        int weight = 313;
        short weightShort = (short) weight;  //eğer 313 çok daha büyük bi rakam olsaydı veri kaybı olurdu, mesela 33binin üzerinde olsaydı.
