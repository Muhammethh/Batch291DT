...
public class InstanceBlock1 {
    ...
    public static void main(String[] args) {
        ...
        InstanceBlock1 obj1 = new InstanceBlock1();//Merhaba java kullanıcıları
        InstanceBlock1 obj2 = new InstanceBlock1();//Merhaba java kullanıcıları
