...
public class Queue01 {
    public static void main(String[] args) {
        ...
        System.out.println(storage.poll()); //kuyruk boş olduğu için null döndürdü

        //6)element(): Kuyruğun başındaki öğeyi döndürür, ancak kuyruk boşsa bir istisna fırlatır.

        // System.out.println(storage.element()); // boş olduğu için exception attı.
        ...
        //Elemanları alt alta yazmak isteseydik
        for (String w : d) {
