 ...
 */
        ...
        System.out.println(result); //B için 1 verdi, C için -3 veriyor çünkü C olsa 3. indekste olacaktı
        ...
        System.out.println(Arrays.binarySearch(arr, 9));//-5 çünkü en sonda olacaktı yine
