...
*/
        ...
        //-------------------------
        String s = "Java";
       // s.substring() => Bu methodu bir String objesi üzerinden çağırırı.Böyle metotlara non-static metot denir.

       // Math.min() ==> Bu methodu direk class adıyla çağırdık. Böyle metotlara static denir.
    ...
    //s.substring(int beginIndex, int begnIndex); ==> iki parametre almis

    //Method ismi + Parametre = Method Signature (Method imzası)
    //----------------------------------------
