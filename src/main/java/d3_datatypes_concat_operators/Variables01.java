...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        long sayi1 = 789456123L, sayi2 = 123456789;
        ...
        System.out.println("Sum = " + (shirtPrice1 + sockPrice1));

        //2. yol:

        float sockPrice2 = 12.99F, shirtPrice2 = 25.99F;
        System.out.println("Sum2:" + (sockPrice2 + shirtPrice2));
        ...
        System.out.println(cellWeight);  // sonuç:2.8E-14  ==> 2.8 çarpı 10 üzeri -14 demek
