...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sLength); //12 boşlukları da sayar
        ...
        char SonKarakter = s.charAt(11);
        System.out.println(SonKarakter);

        char sonKarakter2 = s.charAt(s.length() - 1); //dynamic code, cümlerin sonuna ek de yapılsa son karakteri verir
