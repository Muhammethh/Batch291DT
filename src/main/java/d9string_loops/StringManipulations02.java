...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        String creditNum = "1234 6789 1234 6789";
        String first = creditNum.substring(0, 15).replaceAll("[0-9]", "*");
        System.out.println(first);

        String last = creditNum.substring(15);
        String unite = first + last;

        System.out.println(unite);

        String unite2 = first.concat(last);
        System.out.println(unite2);
