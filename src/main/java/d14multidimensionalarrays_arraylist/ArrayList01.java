...
*/
        ...
        ArrayList<Integer> ages = new ArrayList<>(); //Java 7 ve sonrası -type infrence
        ...
        ages.add(3,7); //12 ile 5 arasına 7 ekle

        System.out.println(ages); //[9, 28, 12, 7, 5]

        ages.add(5,11); // 5den sonraya 11 ekle
        ...
        System.out.println(a); //2 ----> eski değeri döndürdü
