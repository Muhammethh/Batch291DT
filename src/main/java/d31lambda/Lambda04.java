...
public class Lambda04 {
    ...
    public static void main(String[] args) {
        ...
        //List<String> dönüşList = getElementLengthMoreThanFiveWithUpperCase(myList);
        //System.out.println("dönüşList = " + dönüşList);
    ...
    //example 2: Write a method that prints all unique (non-repetitive) elements with less than 5
    ...
    //Example 3:Write a method that converts all elements with more than 5 characters in a List<String> to uppercase
    // and returns these elements as a new list.
