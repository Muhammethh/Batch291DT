...
public class LinkedList01 {
    ...
    —Collections, Java programcılarının aşağıdakileri yapmasına olanak tanır:
        ...
        System.out.println(myList); //[Ali, Veli, Ayse, Fatma] - insertion order - ekleme sirası
        ...
        LinkedList<String> linkedList = new LinkedList<>(Arrays.asList("Eleman 1", "Eleman 2", "Eleman 3"));
        System.out.println(linkedList); //[Eleman 1, Eleman 2, Eleman 3]


        LinkedList<String> linkedList2 = new LinkedList<>(List.of("Eleman 1", "Eleman 2", "Eleman 3"));
        System.out.println(linkedList2); //[Eleman 1, Eleman 2, Eleman 3]
       ...
       /* List<String> immutableList = List.of("Eleman 1", "Eleman 2", "Eleman 3");
