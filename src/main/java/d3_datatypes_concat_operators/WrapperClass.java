...
public class WrapperClass {
    ...
    public static void main(String[] args) {
        ...
        //Wrapper'lar büyük harfle başlar çünkü classdırlar.
        // primitive          : char          - boolean - byte - short - int         - long  - float  - double
        //wrapper class       : Character     - Boolean - Byte - Short - Integer     - Long  - Float  - Double

        int i = 12;
        //i. yaptığımızda method açılmaz

        Integer k = 12;
        //k. yaptığımızda methodlar açılır, methodların başında kırmızı M harfi var
        ...
        //Örnek 2 : Wrapper Byte'i primitive byte'a çeviriniz (unboxing)

        Byte num2 = 50;
        byte primitiveNum2 = num2;
