...
public class CourseRunner {
    public static void main(String[] args) {
        ...
        /*String name1 = coursesList.
                ...
                get().
                getCourseName();
        System.out.println("name1 = " + name1); //name1 = Turkish Night*/
        ...
        List<Course> courseListSorted = coursesList.
                stream().
                sorted(Comparator.comparing(Course::getNumberOfStudents).reversed()).collect(Collectors.toList());
        System.out.println("myList2 = " + courseListSorted);
        ...
        System.out.println("english = " + english); //2
